...
$string['navfilter_desc'] = 'Enable to process filter the custom menu through Moodle filters. Useful for dynamic custom menu items.';
$string['navfiltersexcluded'] = 'Excluded filters in the custom menu';
$string['navfiltersexcluded_desc'] = 'These filters will not be applied to the primary navigation (custom menu). Must be a comma separated list of filter names. The default list includes the core auto-linking filter.';
