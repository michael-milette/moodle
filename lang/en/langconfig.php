...
$string['dateintervalmoday'] = '%mmo %dd';
$string['dateintervalmodayfull'] = '%m months %d days';
$string['dateintervalmodayhr'] = '%mmo %dd %hh';
$string['dateintervalmodayhrfull'] = '%m months %d days %h hours';
$string['dateintervalmodayhrmin'] = '%mmo %dd %hh %im';
$string['dateintervalmodayhrminfull'] = '%m months %d days %h hours %i minutes';
$string['dateintervalmodayhrminsec'] = '%mmo %dd %hh %im %ss';
$string['dateintervalmodayhrminsecfull'] = '%m months %d days %h hours %i minutes %s seconds';
...
$string['dateintervalyrmoday'] = '%yy %mmo %dd';
$string['dateintervalyrmodayfull'] = '%y years %m months %d days';
$string['dateintervalyrmodayhr'] = '%yy %mmo %dd %hh';
$string['dateintervalyrmodayhrfull'] = '%y years %m months %d days %h hours';
$string['dateintervalyrmodayhrmin'] = '%yy %mmo %dd %hh %im';
$string['dateintervalyrmodayhrminfull'] = '%y years %m months %d days %h hours %i minutes';
$string['dateintervalyrmodayhrminsec'] = '%yy %mmo %dd %hh %im %ss';
$string['dateintervalyrmodayhrminsecfull'] = '%y years %m months %d days %h hours %i minutes %s seconds';
