    ...
    */
    function renderElement(&$element, $required, $error)
    {
        ...
        if (!$this->_inGroup) {
            ...
            if (!empty($id) and !$element->isFrozen()
                    and !is_a($element, 'MoodleQuickForm_group') 
                    and !is_a($element, 'HTML_QuickForm_static')
                    and !is_a($element, 'MoodleQuickForm_filemanager')) { // moodle hack
